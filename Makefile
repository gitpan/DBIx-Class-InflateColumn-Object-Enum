# This Makefile is for the DBIx::Class::InflateColumn::Object::Enum extension to perl.
#
...
#     ABSTRACT => q[Allows a DBIx::Class user to define a Object::Enum column]
#     AUTHOR => q[Jason M. Mills <jmmills at cpan.org>]
#     DIR => []
#     DISTNAME => q[DBIx-Class-InflateColumn-Object-Enum]
...
FULLEXT = DBIx/Class/InflateColumn/Object/Enum
BASEEXT = Enum
PARENT_NAME = DBIx::Class::InflateColumn::Object
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
LDFROM = $(OBJECT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/DBIx/Class/InflateColumn/Object/Enum.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/DBIx/Class/InflateColumn/Object
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/DBIx/Class/InflateColumn/Object
...
TO_INST_PM = lib/DBIx/Class/InflateColumn/Object/Enum.pm

PM_TO_BLIB = lib/DBIx/Class/InflateColumn/Object/Enum.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/DBIx/Class/InflateColumn/Object/Enum.pm $(INST_MAN3DIR)/DBIx::Class::InflateColumn::Object::Enum.$(MAN3EXT) 
...
TEST_FILE = test.pl
TEST_FILES = t/00-load.t t/01-object-enum.t t/pod-coverage.t t/pod.t
TESTDB_SW = -d
...
ppd:
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="DBICx-TestDatabase" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="DBIx-Class-Schema" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/DBIx/Class/InflateColumn/Object/Enum.pm blib/lib/DBIx/Class/InflateColumn/Object/Enum.pm 
